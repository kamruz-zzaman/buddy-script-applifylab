  ...
  return (
    <div className="_feed_inner_ppl_card _mar_b16">
      ...
      <div className="row">
        <div className="col-xl-3 col-lg-3 col-md-4 col-sm-4 col">
          <div className="_feed_inner_profile_story _b_radious6">
            <div className="_feed_inner_profile_story_image">
              <Image src="/assets/images/card_ppl1.png" alt="Image" width={800} height={600} className="_profile_story_img" />
        ...
        {[2, 3, 4].map((n) => (
          <div
            className={`col-xl-3 col-lg-3 col-md-4 col-sm-4 ${n === 3 ? "_custom_mobile_none" : ""} ${n === 4 ? "_custom_none" : ""}`}
            key={n}
          >
            <div className="_feed_inner_public_story _b_radious6">
              <div className="_feed_inner_public_story_image">
                <img
                  src={`/assets/images/card_ppl${n}.png`}
                  alt="Image"
                ...
                <div className="_feed_inner_public_mini">
                  <Image src="/assets/images/mini_pic.png" alt="Image" width={800} height={600} className="_public_mini_img" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
      <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
        <div className="_feed_inner_timeline_post_top">
          <div className="_feed_inner_timeline_post_box">
            <div className="_feed_inner_timeline_post_box_image">
              <Image src="/assets/images/post_img.png" alt="" width={800} height={600} className="_post_img" />
            </div>
        ...
        <div className="_feed_inner_timeline_image">
          <Image src="/assets/images/timeline_img.png" alt="" width={800} height={600} className="_time_img" />
        </div>
      </div>
      <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
        <div className="_feed_inner_timeline_total_reacts_image">
          <Image src="/assets/images/react_img1.png" alt="Image" width={800} height={600} className="_react_img1" />
          <Image src="/assets/images/react_img2.png" alt="Image" width={800} height={600} className="_react_img" />
          <Image src="/assets/images/react_img3.png" alt="Image" width={800} height={600} className="_react_img _rect_img_mbl_none" />
          <Image src="/assets/images/react_img4.png" alt="Image" width={800} height={600} className="_react_img _rect_img_mbl_none" />
          <Image src="/assets/images/react_img5.png" alt="Image" width={800} height={600} className="_react_img _rect_img_mbl_none" />
